...
int SMTPSocket::SMTPInit()
{
	...
	back = TCPRecv(*(this->MSocket),(char*)recvbuff, rbuffsize);
...
int SMTPSocket::Login()
{
	...
	back=TCPSendRecv(*(this->MSocket), helo, sbuffsize, (char*)recvbuff, rbuffsize);
	if (back == SOCKET_ERROR)
		return back;
...
int SMTPSocket::SendMail()
{
	...
	back = TCPSendRecv(*(this->MSocket), mailFrom,
		mailFromsize, (char*)recvbuff, rbuffsize);
	if (back == SOCKET_ERROR)
		return back;
	...
	back = TCPSendRecv(*(this->MSocket), mailTo,
		mailTosize, (char*)recvbuff, rbuffsize);
	if (back == SOCKET_ERROR)
		return back;
	...
	back = TCPSendRecv(*(this->MSocket), sendData,
		sendSize, (char*)recvbuff, rbuffsize);
	if (back == SOCKET_ERROR)
		return back;
